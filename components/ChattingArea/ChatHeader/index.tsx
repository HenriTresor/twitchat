...
function ChatHeader({}: Props) {
  return (
      <div className='w-full p-2 flex justify-between items-start border-b-2 h-auto border-slate-100 sticky top-0 z-999 backdrop-blur-sm bg-[rgb(0,0,0,.01)] items-end'>
